...
import com.hyphenate.helpdesk.easeui.VoiceRecorder;
import com.hyphenate.helpdesk.easeui.util.CommonUtils;
import com.hyphenate.helpdesk.easeui.widget.chatrow.ChatRowVoicePlayClickListener;
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (event.getY() < 0) {
                    ...
                    try {
                        ...
                        } else if (length == com.hyphenate.helpdesk.Error.FILE_INVALID) {
