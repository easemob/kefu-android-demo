...
import com.hyphenate.helpdesk.easeui.agora.gles.SinkConnector;
    ...
    private void initModules() {
        ...
        mScreenCapture.setOnScreenCaptureListener(new ScreenCapture.OnScreenCaptureListener() {
            ...
            public void onStarted() {
                ...
                for (int i = 0; i < N; i++) {
                    try {
                        mCallbacks.getBroadcastItem(i).onDialogStart();
            ...
            public void onError(int err) {
                ...
                for (int i = 0; i < N; i++) {
                    try {
                        mCallbacks.getBroadcastItem(i).onDialogDeniedError(err);
                    } catch (RemoteException e) {
                        // The RemoteCallbackList will take care of removing
                        // the dead object for us.
                    }
