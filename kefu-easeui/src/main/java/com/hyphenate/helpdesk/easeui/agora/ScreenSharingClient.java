...
import com.hyphenate.helpdesk.easeui.agora.impl.ScreenSharingService;
...
//    }
    ...
    private final INotification mNotification = new INotification.Stub() {
        ...
        @Override
        public void onDialogStart() throws RemoteException {
            mStateListener.onDialogStart();
        }

        @Override
        public void onDialogDeniedError(int error) throws RemoteException {
            mStateListener.onDialogDeniedError(error);
        }
    };
