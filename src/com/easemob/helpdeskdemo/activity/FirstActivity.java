...
//		RadioGroup rg = (RadioGroup) findViewById(R.id.main_btn_group);
//		rg.setBackgroundColor(Color.TRANSPARENT);
		...
		mRadioButtons[0] = (RadioButton) findViewById(R.id.main_btn_home_page);
		mRadioButtons[1] = (RadioButton) findViewById(R.id.main_btn_setting_page);
		// 把shopFragment设为选中状态
	...
	public void onTabClick(View view) {
		...
		ColorStateList csl = (ColorStateList) resource.getColorStateList(R.color.text_selected_color);
		switch (view.getId()) {
...
//								pd.dismiss();
//							// 进入主页面
//							startActivity(new Intent(FirstActivity.this, ChatActivity.class).putExtra("userId", "customers"));
//							finish();
//						}
//
//						@Override
