...
public class DiagnoseActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!TextUtils.isEmpty(strVersion))
			...
			currentVersion.setText(R.string.not_setting);
	}
	...
	public void uploadlog() {
		...
		progressDialog.setMessage(getResources().getString(R.string.Upload_the_log));
		...
		EMChat.getInstance().uploadLog(new EMCallBack() {
			...
			public void onSuccess() {
				runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						Toast.makeText(DiagnoseActivity.this, R.string.Upload_the_log_successful,
			...
			public void onError(int code, String message) {
				...
				runOnUiThread(new Runnable() {
					...
					public void run() {
						progressDialog.dismiss();
						Toast.makeText(DiagnoseActivity.this, R.string.Upload_the_log_failure,
								Toast.LENGTH_SHORT).show();
					}
				});
