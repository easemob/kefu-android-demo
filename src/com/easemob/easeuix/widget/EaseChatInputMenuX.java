...
import com.easemob.easeuix.widget.EaseChatExtendPrompt.EaseChatExtendPromptItemClickListener;
import com.easemob.easeuix.widget.EaseChatPrimaryMenuBaseX.EaseChatPrimaryMenuListenerX;
...
public class EaseChatInputMenuX extends LinearLayout {
	...
	public void registerExtendPromptItem(String name, int itemId, EaseChatExtendPromptItemClickListener listener) {
	...
	public void registerExtendPromptItem(int nameRes, int itemId, EaseChatExtendPromptItemClickListener listener) {
		chatExtendPrompt.registerPromptItem(nameRes, itemId, listener);
	}

	protected void processChatMenu() {
		// 发送消息栏
		chatPrimaryMenu.setChatPrimaryMenuListener(new EaseChatPrimaryMenuListenerX() {
