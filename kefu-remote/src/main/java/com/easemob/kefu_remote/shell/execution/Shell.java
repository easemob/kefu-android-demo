 ...
 */
package com.easemob.kefu_remote.shell.execution;

import android.content.Context;

import com.easemob.kefu_remote.shell.RootShell;
...
public class Shell {
    ...
    private Shell(String cmd, ShellType shellType, ShellContext shellContext, int shellTimeout) throws IOException, TimeoutException,
            RootDeniedException {
