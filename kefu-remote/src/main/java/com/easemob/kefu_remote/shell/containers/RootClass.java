package com.easemob.kefu_remote.shell.containers;
...
/* #ANNOTATIONS @SupportedAnnotationTypes("com.easemob.superrtc.demo.call.shell.containers.RootClass.Candidate") */
...
public class RootClass /* #ANNOTATIONS extends AbstractProcessor */ {
    ...
    */
    ...
    public RootClass(String[] args) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException,
