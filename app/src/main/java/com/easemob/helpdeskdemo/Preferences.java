...
public class Preferences {
    ...
    static private String KEY_START_REMOTE = "start_remote";
    ...
    public synchronized int getRemoteStatus() {
        return pref.getInt(KEY_START_REMOTE, 2);
    }

    public synchronized void setRemoteStatus(int mode) {
        editor.putInt(KEY_START_REMOTE, mode).commit();
    }
